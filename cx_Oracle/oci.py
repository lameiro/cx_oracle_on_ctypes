...
ORACLE_10G = 'OCI_ATTR_MODULE' in locals()
ORACLE_10GR2 = 'OCI_MAJOR_VERSION' in locals()
ORACLE_11 = 'OCI_ATTR_CONNECTION_CLASS' in locals()
ORACLE_12 = 'OCI_ATTR_DML_ROW_COUNT_ARRAY' in locals()
